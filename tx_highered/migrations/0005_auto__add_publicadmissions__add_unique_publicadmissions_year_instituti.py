...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PublicAdmissions'
        db.create_table('tx_highered_publicadmissions', (
            ...
            ('institution', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publicadmissions', to=orm['tx_highered.Institution'])),
        ...
        db.send_create_signal('tx_highered', ['PublicAdmissions'])

        # Adding unique constraint on 'PublicAdmissions', fields ['year', 'institution']
        db.create_unique('tx_highered_publicadmissions', ['year', 'institution_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PublicAdmissions', fields ['year', 'institution']
        db.delete_unique('tx_highered_publicadmissions', ['year', 'institution_id'])

        # Deleting model 'PublicAdmissions'
        db.delete_table('tx_highered_publicadmissions')
    ...
    models = {
        ...
        'tx_highered.publicadmissions': {
            'Meta': {'ordering': "['year']", 'unique_together': "(('year', 'institution'),)", 'object_name': 'PublicAdmissions'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institution': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publicadmissions'", 'to': "orm['tx_highered.Institution']"}),
            'number_admitted': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'number_admitted_who_enrolled': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'number_of_applicants': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'percent_of_admitted_who_enrolled': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '1', 'blank': 'True'}),
